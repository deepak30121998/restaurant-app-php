...
<?php
    ...
    if(isset($_POST['submit'])) {
        ...
        $query = "INSERT INTO orders (name, email, town, country, zipcode, phone_number, address, total_cart_price, user_id) VALUES (:name, :email, :town, :country, :zipcode, :phone_number, :address, :total_cart_price, :user_id)";
        $params = [
            ":name" => $name,
            ":email" => $email,
            ":town" => $town,
