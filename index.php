    ...
    <div class="row g-0">
        ...
        <div class="col-md-6 bg-dark d-flex align-items-center">
            <div class="p-5 wow fadeInUp" data-wow-delay="0.2s">
                ...
                <form method="post" action="booking_table.php" onsubmit="return validateTime()">
                    <div class="row g-3">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="form-floating date">
                                <input name="date_booking" type="datetime-local" class="form-control" id="bookingtime" placeholder="Date & Time" />
                                <label for="datetime">Date & Time</label>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-floating">
                                <select class="form-select" id="select1" name="num_people">
...
<script>
    function validateTime() {
        ...
        // Check if the selected time is within the allowed range (10 AM to 10 PM)
